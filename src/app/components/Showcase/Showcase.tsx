    ...
    return (
        <div data-gsap='showcase' className="pt-[100vh] relative w-screen h-full bg-[#FAF5EF] z-10">
            ...
            <div data-gsap='showcase-opacity-target' className="w-full h-full">
                ...
                <div className="flex items-center justify-center w-full h-full pt-[30px] pb-[100px] sm:pb-[200px]">
                ...
                <div className="w-full h-full bg-[#232323] relative">
                    ...
                    <div className="flex items-center justify-center w-full h-full pt-[150px] pb-[100px] sm:py-[150px] md:py-[250px] lg:pb-[200px] lg:pt-[300px]">
