export default function Logo() {
    return (
        <div className="fixed top-0 left-0 w-screen p-[50px] flex items-center justify-between z-50">
            <p className="opacity-0 hidden lg:block font-progLight text-md leading-[28px] text-[#F4F5F2] tracking-[-1.25px]">Advanced Manufacturing<br></br>Company of America</p>

            <svg xmlns="http://www.w3.org/2000/svg" className="block lg:hidden" width="52" height="36" viewBox="0 0 52 36" fill="none">
            ...
            <button className="cursor-pointer font-reckless text-sm leading-[28px] text-white tracking-[-1.1px] hover:opacity-50 duration-150 transition-opacity">Go to Careers&nbsp;&nbsp;→</button>
        </div>
    )
}